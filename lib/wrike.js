...
Wrike.prototype.__buildEndpoint = function(path,base){
  if(base == 'rest'){
...
Wrike.prototype.__request = function(method, path, params, callback) {
  ...
  //Correctly encode metadata param
  if(params.metadata){
    params.metadata = JSON.stringify(params.metadata);
  }
  //Correctly encode profile param
  if(params.profile){
    params.profile = JSON.stringify(params.profile);
  }
